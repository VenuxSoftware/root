$(document).ready(function () {
    ...
    */
    $('.hover_wrapper').mouseenter(function () {
        ...
        $(this).children('.icon_wrapper').children('.bottom_wrapper').children('.location_wrapper').children('.protocall_icons').css('-webkit-filter', 'grayscale(0)'); //-webkit extension is required. This will not work in FF
        //$(this).children('.icon_wrapper').children('.bottom_wrapper').children('.location_wrapper').children('.location').css({ 'color': '#51b6ec' }); //-webkit extension is required. This will not work in FF
    });
    ...
    $('.hover_wrapper').mouseleave(function () {
        ...
        //$(this).children('.icon_wrapper').children('.bottom_wrapper').children('.location_wrapper').children('.location').css({'color': ''}); //-webkit extension is required. This will not work in FF
    });
});